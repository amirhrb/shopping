...
const Product = ({data}) => {
    ...
    return (
        <div className={styles.mainDiv}>
           ...
           <span>{data.price} <img src={priceTag} alt='$' /></span>
           {
            ...
            <button onClick={()=>dispatch({type:"REMOVE_ITEM",payload:data})} className={styles.trashBtn}>
                <img src={trash} alt='trash' className={styles.trash}/> 
            </button>
            :
            <button onClick={()=>dispatch({type:"DECREASE",payload:data})} className={styles.minusBtn} >
                <img src={minus} alt='minus' />
            </button>
            }
            </div>
            :
            <button onClick={()=>dispatch({type:"ADD_ITEM",payload:data})} className={styles.buyBtn}>Buy</button>         
            }
           </div>
           </div>
