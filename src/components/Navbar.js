...
const Nav = styled.div`
    ...
    @media (min-width:640px){
        ${props=>props.isScrolled?
            'background-color:rgba(0,0,0,1)' : 'background-color:rgba(45, 212, 191,0.8)'
        }
    }
`
...
const Ul=styled.ul`
    @media (min-width:640px){
        ...
        a{
            ${props=>props.isScrolled?
                'color:#2DD4BF' : 'color:rgb(250,250,250)'
            }
        }   
    }
    ...
    return (
            <Nav isClicked={isClicked} isScrolled={isScrolled}>
                ...
                <Ul isClicked={isClicked} isScrolled={isScrolled}>
                    ...
                    <Link to="/info" onClick={Handler}>info</Link>
                    <Link to="/store" onClick={Handler}>Store</Link>
                </Ul>
